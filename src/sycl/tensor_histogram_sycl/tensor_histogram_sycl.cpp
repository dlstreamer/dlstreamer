...
#include "dlstreamer/sycl/elements/tensor_histogram_sycl.h"
...
class TensorHistogramSYCL : public BaseHistogram {
  public:
    TensorHistogramSYCL(DictionaryCPtr params, const ContextPtr &app_context) : BaseHistogram(params, app_context) {
...
extern "C" {
ElementDesc tensor_histogram_sycl = {
    .name = "tensor_histogram_sycl",
    .description = "Calculates histogram on tensors of UInt8 data type and NHWC layout",
    .author = "Intel Corporation",
    .params = &TensorHistogramSYCL::params_desc,
    ...
    .create = create_element<TensorHistogramSYCL>,
    .flags = 0};
}
