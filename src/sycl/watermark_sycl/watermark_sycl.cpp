...
#include "dlstreamer/sycl/elements/watermark_sycl.h"
...
class WatermarkSYCL : public BaseWatermark {
  public:
    WatermarkSYCL(DictionaryCPtr params, const ContextPtr &app_context) : BaseWatermark(params, app_context) {
...
ElementDesc watermark_sycl = {
    ...
    .create = create_element<WatermarkSYCL>,
    .flags = 0};
}
