...
#include "dlstreamer/cpu/elements/tensor_sliding_aggregate.h"
...
class TensorSlidingAggregate : public BaseTransform {
  public:
    TensorSlidingAggregate(DictionaryCPtr /*params*/, const ContextPtr &app_context) : BaseTransform(app_context) {
    }

    ~TensorSlidingAggregate() {
...
extern "C" {
ElementDesc tensor_sliding_aggregate = {.name = "tensor_sliding_aggregate",
                                        ...
                                        .create = create_element<TensorSlidingAggregate>,
                                        .flags = 0};
}
