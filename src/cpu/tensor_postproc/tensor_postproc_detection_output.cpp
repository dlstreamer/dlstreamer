...
class TensorPostProcDetectionOutput : public BaseTransformInplace {
  public:
    TensorPostProcDetectionOutput(DictionaryCPtr params, const ContextPtr &app_context)
...
extern "C" {
ElementDesc tensor_postproc_detection_output = {
    ...
    .create = create_element<TensorPostProcDetectionOutput>,
    .flags = 0};
}
