...
class PostProcCopyParams : public BaseTransformInplace {
  public:
    PostProcCopyParams(DictionaryCPtr params, const ContextPtr &app_context)
...
extern "C" {
ElementDesc tensor_postproc_copy_params = {.name = "tensor_postproc_copy_params",
                                           .description =
                                               "Post-processing to only copy properties/parameters to metadata",
                                           .author = "Intel Corporation",
                                           .params = &params_desc,
                                           .input_info = {MediaType::Tensors},
                                           .output_info = {MediaType::Tensors},
                                           .create = create_element<PostProcCopyParams>,
                                           .flags = 0};
}
