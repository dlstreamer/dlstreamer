...
GST_PLUGIN_DEFINE(GST_VERSION_MAJOR, GST_VERSION_MINOR, dlstreamer_cpu,
                  PRODUCT_FULL_NAME " elements implemented on C++ without backend dependencies", plugin_init,
