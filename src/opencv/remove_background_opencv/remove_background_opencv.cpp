...
#include "dlstreamer/opencv/elements/remove_background_opencv.h"
...
class RemoveBackgroundOpenCV : public BaseTransformInplace {
  public:
    static constexpr auto mask_format = "mask";

    RemoveBackgroundOpenCV(DictionaryCPtr params, const ContextPtr &app_context) : BaseTransformInplace(app_context) {
...
extern "C" {
ElementDesc remove_background_opencv = {.name = "remove_background_opencv",
                                        ...
                                        .create = create_element<RemoveBackgroundOpenCV>,
                                        .flags = 0};
}
