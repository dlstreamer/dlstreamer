...
#include "dlstreamer/opencv/elements/find_contours_opencv.h"
...
class FindContoursOpenCV : public BaseTransformInplace {
  public:
    static constexpr auto mask_format = "mask";
    static constexpr auto contour_format = "contour_points";

    FindContoursOpenCV(DictionaryCPtr params, const ContextPtr &app_context) : BaseTransformInplace(app_context) {
