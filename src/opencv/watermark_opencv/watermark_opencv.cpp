...
#include "dlstreamer/opencv/elements/watermark_opencv.h"
...
class WatermarkOpenCV : public BaseWatermark {
  public:
    struct param {
    ...
    WatermarkOpenCV(DictionaryCPtr params, const ContextPtr &app_context) : BaseWatermark(params, app_context) {
...
ParamDescVector WatermarkOpenCV::params_desc = {
...
extern "C" {
ElementDesc watermark_opencv = {
    .name = "watermark_opencv",
    .description = "Visualize inference results using OpenCV",
    .author = "Intel Corporation",
    .params = &WatermarkOpenCV::params_desc,
    ...
    .output_info = {FrameInfo(ImageFormat::BGRX, MemoryType::VAAPI), FrameInfo(ImageFormat::RGBX, MemoryType::VAAPI),
                    FrameInfo(ImageFormat::BGRX, MemoryType::CPU), FrameInfo(ImageFormat::RGBX, MemoryType::CPU)},
    .create = create_element<WatermarkOpenCV>,
    .flags = 0};
}
