...
#include "dlstreamer/opencv/elements/warp_affine_opencv.h"
...
class WarpAffineOpenCV : public BaseTransform {
  public:
    WarpAffineOpenCV(DictionaryCPtr params, const ContextPtr &app_context) : BaseTransform(app_context) {
...
extern "C" {
ElementDesc warp_affine_opencv = {.name = "warp_affine_opencv",
                                  ...
                                  .create = create_element<WarpAffineOpenCV>,
                                  .flags = 0};
}
