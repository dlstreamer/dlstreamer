...
ZeroTermChistTracklet::ZeroTermChistTracklet() : Tracklet(), birth_count(1) {
}

ZeroTermChistTracklet::~ZeroTermChistTracklet() {
}

std::deque<cv::Mat> *ZeroTermChistTracklet::GetRgbFeatures() {
    return &rgb_features;
}
