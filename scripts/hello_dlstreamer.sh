...
if [ -d "$MODELS_PATH"/public/yolo11s/FP32 ]; then
	...
	/home/"$USER"/python3venv/bin/pip3 install --no-cache-dir --no-dependencies PyGObject ultralytics openvino==2025.0.0 numpy typing-extensions Pillow opencv-python matplotlib packaging pyparsing cycler python-dateutil kiwisolver six pyyaml tqdm requests urllib3 idna certifi psutil sympy mpmath thop setuptools
