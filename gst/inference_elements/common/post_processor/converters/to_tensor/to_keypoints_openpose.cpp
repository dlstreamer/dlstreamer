...
#include "to_keypoints_openpose.h"
...
TensorsTable ToKeypointsOpenPoseConverter::convert(const OutputBlobs &output_blobs) const {
    ...
    try {
        ...
        std::throw_with_nested(std::runtime_error("Failed to do \"ToKeypointsOpenPoseConverter\" post-processing"));
    }
