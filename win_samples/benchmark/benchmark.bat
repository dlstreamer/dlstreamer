...
if [%VIDEO_FILE_NAME%]==[] (
  echo [91mERROR: Set path to video. ^
  Usage : benchmark.bat VIDEO_FILE [INFERENCE_DEVICE] [CHANNELS_COUNT][0m
  exit /B 1
)
...
set "DETECT_MODEL_PATH=%MODELS_PATH%\intel\face-detection-adas-0001\FP32\face-detection-adas-0001.xml"
