...
DL Streamer uses GStreamer bin elements to simplify creation of a
...
inside DL Streamer bin elements.
...
decode. Deep Learning Streamer (DL Streamer) has following
...
- `vaapi`: GStreamer standard and DL Streamer **low-level
...
DL Streamer provides variety of bin elements to simplify creation
of media analytics pipeline. Most of DL Streamer bin elements
