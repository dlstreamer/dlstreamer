...
| start-time | Start time to use if<br>start-time-selection=set<br>*Default: `1`*8446744073709551615<br> |
...
| batch-size | Batch size<br>*Default: `1`*<br> |
| buffer-pool-size | Output buffer pool size (functionally same as<br>OpenVINO™ toolkit nireq parameter)<br>*Default: `1`*6<br> |
