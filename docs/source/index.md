...
**DL Streamer** makes **Media Analytics** easy:
...
![DL Streamer SW Stack](_images/overview_sw_stack.png)
...
included in
[Deep Learning Streamer Pipeline Framework](https://github.com/open-edge-platform/edge-ai-libraries/tree/release-1.2.0/libraries/dl-streamer),
[DL Streamer Pipeline Server](https://github.com/open-edge-platform/edge-ai-libraries/tree/release-1.2.0/microservices/dlstreamer-pipeline-server),
...
**DL Streamer** is already used by many partners and customers
